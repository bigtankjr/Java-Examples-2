...
//[[arrow]]node:   HHHHHHHTT 
//[[arrow]]index: 3 
//[[arrow]]For example:
       int result = 0;
   
      for (int i = 0; i < 6; i++) //[[arrow]]H H H
//[[arrow]]H H H
//[[arrow]]H T T
         if (node[i] == 'T')
           result = result * 2 + 1;
     ...
     public static char[] getNode(int index) {
      char[] result = new char[9];
       ...
       for (int i = 0; i < 9; i++) {     //[[arrow]]For example: 
//[[arrow]]node:    THHHHHHTT 
//[[arrow]]index: 259
         int digit = index % 2;     //[[arrow]]T H H 
//[[arrow]]H H H 
//[[arrow]]H T T
         if (digit == 0)
           result[8 - i] = 'H';
     ...
     public static void printNode(char[] node) {
       for (int i = 0; i < 9; i++)//[[arrow]]For example: [[arrow]]node:        THHHHHHTT 
            //[[arrow]]Output:
         if (i % 3 != 2)     //[[arrow]]T H H 
//[[arrow]]H H H 
//[[arrow]]H T T
